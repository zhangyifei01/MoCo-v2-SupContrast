...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_dataset = datasets.CIFAR10Instance(root=stldir, train=True, download=True, transform=transform_train)
    ...
    val_dataset = datasets.CIFAR10Instance(root=stldir, train=False, download=True, transform=transform_test)
