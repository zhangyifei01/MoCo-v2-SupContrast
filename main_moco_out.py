...
parser.add_argument('--schedule', default=[600, 800], nargs='*', type=int,
...
parser.add_argument('--warm-up', default=5, type=int,
                    help='feature dimension (default: 128)')
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    for i, (images, labels, index) in enumerate(train_loader):
        adjust_learning_rate(optimizer, epoch, args, i, iteration_per_epoch)
...
def adjust_learning_rate(optimizer, epoch, args, i, iteration_per_epoch):
    base_lr = args.lr
    T = epoch * iteration_per_epoch + i
    warmup_iters = args.warm_up * iteration_per_epoch
    total_iters = (args.epochs - args.warm_up) * iteration_per_epoch
